...
var mainState = {
  // load the images
  preload: function () {
    game.stage.backgroundColor = '#f9fffa';
    game.load.image('bird', 'images/SmallBall130.jpg');
    game.load.image('pipe', 'images/output.jpg');
  },
  ...
  create: function () {
    ...
    //show initial score
    this.score = 0;
    this.labelScore  = game.add.text(20, 20, "0", {font: '25px Bold', fill: '#030503'});
  },
  ...
  addRowOfPipes: function () {
    // create hole in pipe
    var hole = Math.floor(Math.random() * 3) + 2;
